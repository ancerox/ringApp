              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text(
                      "Notifications", // Your centered text
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      width: 65,
                      decoration: BoxDecoration(
                          color: const Color(0xff00FFEC),
                          borderRadius: BorderRadius.circular(30)),
                      child: Center(
                        child: SvgPicture.asset(
                          'assets/svg/medical.svg',
                          height:
                              30, // Adjust this to fit better in the container
                          width: 30, // Optional: Adjust the width if needed
                        ),
                      ),
                    ),
                    const SizedBox(
                    ...
                    Text(
                      ...
                      style: CustomTheme.buttonTextStyle.copyWith(
                          color: const Color(0xff7A949D), fontSize: 15),
                    ),
                  ],
                ),
                const SizedBox(
