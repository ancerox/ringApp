...
class _HeartScreenState extends State<HeartScreen>
  ...
  void initState() {
    ...
    _systolicAnimation = Tween<double>(begin: 0, end: 86).animate(_controller);
                ...
                Row(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: IconButton(
                        onPressed: () {
                          Navigator.pushNamed(context, '/heart_history');
                        },
                  ...
                  children: [
                    ...
                    AnimatedBuilder(
                      ...
                      builder: (context, child) {
                        return Text(
                          "${_systolicAnimation.value.toInt()}",
